...
<html lang="en">
  ...
  <link rel="icon" href="images/favicon.ico" type="image/ico" />
    ...
    <title>Edit Category || Real Choclate</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <img src="./images/<?php echo $fe['image'];?>" height="100px" style="border-radius: 10px;">
        ...
        $Mypic=$_FILES['new_img'];
         ...
         if ($_FILES['new_img']['error']>0) {
              ...
              move_uploaded_file($Mypic['tmp_name'], $NewLocation);
               ...
               $res=$con->query("UPDATE `category` SET `name`='$name' ,`image`='$filename' WHERE `id`='".$_GET['id']."'");
            if($res>0){
               echo "<script>alert('Success! Category Edit Successfully');location.href='category.php';</script>";
            }else{
               echo "<script>alert('CAtegory Update Fail');location.href='category.php';</script>";
            }             
