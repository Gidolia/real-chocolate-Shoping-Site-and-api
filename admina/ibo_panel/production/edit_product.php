...
<html lang="en">
  <head>
    ...
    <title>Edit Category || Real Chocolate</title>
                  ...
                  <div class="x_content">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="upd_name" required="required" class="form-control " value="<?php echo $fe['name'];?>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <img src="./images/<?php echo $fe['img1'];?>" height="100px" style="border-radius: 10px;">
    ...
    if(isset($_POST['edit_prod']))
    {
        ...
        $Mypic=$_FILES['new_img'];
         ...
         if ($_FILES['new_img']['error']>0) {
               header('Location:./product.php?Profile image  Not Selected');
         }else{
              ...
              move_uploaded_file($Mypic['tmp_name'], $NewLocation);
               ...
               $res=$con->query("UPDATE `product` SET `name`='$name' ,`img1`='$filename' WHERE `p_id`='".$_GET['id']."'");
            if($res>0){
               echo "<script>alert('Success! Category Edit Successfully');location.href='product.php';</script>";
            }else{
               echo "<script>alert('CAtegory Update Fail');location.href='product.php';</script>";
            }             
