...
<html lang="en">
  ...
  <link rel="icon" href="images/favicon.ico" type="image/ico" />
    ...
    <title>Product || Real Choclate</title>
  ...
  <body class="nav-md">
    ...
    if(isset($_POST['ad_cat']))
    {
        ...
        $abc=$con->query("SELECT * FROM `category` WHERE `c_id`='$cid'");
        $my=$abc->fetch_assoc();
        //print_r($my);
    ...
    {
        if (file_exists("pro2" .$fe['max_id'].".jpg"))
            {
              unlink("pro2" .$fe['max_id'].".jpg");
              //echo $fe['max_id'].".jpg" . " already exists. ";
            }
      ...
      $hg="INSERT INTO `product` ( `p_id`,`unq_id`, `c_id`, `name`, `date`, `time`, `mrp`, `dp`, `qty`, `note`, `status`, `short_description`, `long_description`, `img1`, `img2`, `discount`) VALUES ('', '$unq', '$cid', '$name', '$date', '$time', '$mrp', '$dp', '$qty', '', '', '$sd', '$ls', '$img1', '$img2', '$dic%')";        
