...
<html lang="en">
  <head>
    ...
    <title>Category || Real Chocolate</title>
    ...
    if(isset($_POST['ad_cat']))
    {
        ...
        if(move_uploaded_file($_FILES['img']['tmp_name'], "images/cat".$unqid.".jpg"))
		{
		  //  $val=$fe['max_id']+1;
            ...
            $rf="INSERT INTO `category`(`id`, `name`, `image`, `unq_id`, `c_id`) VALUES ('null','$category','$file','$unqid','$hfuy')";
    ...
    ?>
        ...
        <table class="table table-striped table-bordered" id="datatable">
            ...
            <tr>
                ...
                <th><img src="./images/<?php echo $d['image'];?>" height="70px" weight="70px">
                <?php echo $d['image'];?></th>
