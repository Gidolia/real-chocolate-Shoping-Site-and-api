...
<html lang="en">
  <head>
    ...
    <title>CoPartner || Real Chocolate</title>
...
/////////////////////// end Enter New Category///////////////////////////
    if(isset($_POST['ad_cat']))
    {
        ...
        if(move_uploaded_file($_FILES["img"]["tmp_name"], "cat".$fe['max_id'].".jpg"))
		{
		    $file="cat" .$fe['max_id'].".jpg";
            $unqid=rand(1000,9999);
            $rf="INSERT INTO `category` (`id`, `name`, `image`, `c_id`,`unq_id`) VALUES (NULL, '".$_POST['cat_name']."', '$file', '$hfuy','$unqid')";
